...
try{
    ...
    # download a tool to minify .css/.js
    ...
    'Minifying css and js files' | Write-Output
    & "$(Get-NuGetPackage -name AzureMinifier -prerelease)\bin\TextMinifier.job.exe" /d $packOutput --noreport
